...
subroutine solvePhi(root, args, nargs, rootOld)
    ...
    ! Set the safe bounds
    rootMax = 0.9999999D0 ! corresponds to nearly 100% dry polymer
...
!     1. Solve for current polymer volume fraction (PHI)
      ...
      ARGS(7) = KBULK
      ARGS(8) = DET
      write(*,*) 'Solving for phi...'
      write(*,*) 'ARGS: ', ARGS
      write(*,*) 'PHI_T: ', PHI_T
      CALL SOLVEPHI(PHI_TAU, ARGS, NARGS, PHI_T)
      write(*,*) 'Solved for phi...'
...
!      CAUCHY STRESS
      ...
      write(*,*) 'SIGVOL'
        ...
        write(*,*) SVOL(3,1), SVOL(3,2), SVOL(3,3)
      write(*,*) 'SISO'
        write(*,*) SISO(1,1), SISO(1,2), SISO(1,3)
        write(*,*) SISO(2,1), SISO(2,2), SISO(2,3)
        write(*,*) SISO(3,1), SISO(3,2), SISO(3,3)
      SIGMA = SVOL + SISO
!----------------------------------------------------------------------
