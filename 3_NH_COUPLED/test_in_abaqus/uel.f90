...
!      Energy = zero
         ...
         do i = 1, NNODE
            ...
            do intpt = 1, nInttPt
               ...
               write(*, *) 'detF_t before material routine =', detF_t
               write(*, *) 'detF_tau befora material routine =', detF_tau
               write(*, *) 'F_t before material routine =', F_t
               write(*, *) 'F_tau befora material routine =', F_tau
               !@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
               !
