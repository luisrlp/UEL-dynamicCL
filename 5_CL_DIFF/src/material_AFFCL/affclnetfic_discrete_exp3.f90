!! IDEA IS TO ALSO DIVIDE THE STRETCH IN SUB-STEPS
...
!         cb_sub = MAX(cb(node_num), 1.0d-8)                                                                                  
!         kon = Koff0 * Keq * exp(CHI * (1.0d0 - 2.0d0 * thetaf))

!         ! ------------------------------------
!         DO isub = 1, n_sub                                                                                                  
!         ! 1. Update Geometry                                                                                            
!         r0f = 1.6 * (10.0d3 * cb_sub)**(-two/5.0d0)                                                                     
!         l = aratio * r0f                                                                                                
!         r0 = r0f + r0c                                                                                                  
                                                                                                                        
!         ! 2. Compute stretch partition                                                                                  
...
!         thetab_i = MIN(MAX(cb_sub / cbmax, 1.0d-6), one - 1.0d-6)                                                       
...
!     ! --- Final state for stress accumulation ---                                                                       
