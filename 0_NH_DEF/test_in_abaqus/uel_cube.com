...
options = {
    ...
    'compile_fortran':['ifx', '-V', '-free', '-c', '-fpp', '-fPIC', '-extend_source', '-DABQ_LNX86_64', '-DABQ_FORTRAN', '-auto', '-pc64', '-align', '-prec-div', '-prec-sqrt', '-fp-model', 'precise', '-fimf-arch-consistency=true', '-mP2OPT_hpo_vec_divbyzero=F', '-no-fma', '-fp-speculation=safe', '-fprotect-parens', '-fstack-protector-strong', '-reentrancy', 'threaded', '-init=snan', '-init=arrays', '-msse3', '-axcore-avx2,avx', '-WB', '-I%I', '-I/opt/Simulia/EstProducts/2024', '%P'],
