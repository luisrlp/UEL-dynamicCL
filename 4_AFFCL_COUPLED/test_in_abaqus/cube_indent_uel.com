...
options = {
    ...
    'compile_fortran':['ifx', '-V', '-free', '-c', '-fpp', '-fPIC', '-extend-source', '-DABQ_LNX86_64', '-DABQ_FORTRAN', '-auto', '-pc64', '-align', '-prec-div', '-fp-model', 'precise', '-no-fma', '-fp-speculation=safe', '-fprotect-parens', '-fstack-protector-strong', '-reentrancy', 'threaded', '-init=snan', '-init=arrays', '-msse3', '-axcore-avx2,avx', '-WB', '-I%I', '-I/opt/Simulia/EstProducts/2025', '%P'],
    ...
    'link_sl':['ifx', '-V', '-cxxlib', '-fPIC', '-threads', '-shared', '-Wl,--add-needed', '%E', '-Wl,-soname,%U', '-o', '%U', '%F', '%A', '%L', '%B', '-parallel', '-Wl,-Bdynamic', '-shared-intel'],
    'magnetostatic':OFF,
    'massDiffusion':OFF,
